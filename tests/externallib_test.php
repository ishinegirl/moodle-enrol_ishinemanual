...
/**
 * Enrol ishinemanual external PHPunit tests
 *
...
require_once($CFG->dirroot . '/enrol/ishinemanual/externallib.php');

class enrol_ishinemanual_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_enrol_users() {
        ...
        $roleid = $this->assignUserCapability('enrol/ishinemanual:enrol', $context1->id);
        ...
        $this->assignUserCapability('enrol/ishinemanual:enrol', $context2->id, $roleid);
        ...
        enrol_ishinemanual_external::enrol_users(array(
        ...
        $this->unassignUserCapability('enrol/ishinemanual:enrol', $context1->id, $roleid);
        try {
            enrol_ishinemanual_external::enrol_users(array(
                array('roleid' => 3, 'userid' => $user1->id, 'courseid' => $course1->id),
            ));
        ...
        $this->assignUserCapability('enrol/ishinemanual:enrol', $context1->id, $roleid);
        ...
        // Call for course without ishinemanual instance.
        $DB->delete_records('user_enrolments');
        ...
        try {
            ...
            $this->fail('Exception expected if course does not have ishinemanual instance');
        } catch (moodle_exception $e) {
    ...
    public function test_unenrol_user_single() {
        ...
        $enrol = enrol_get_plugin('ishinemanual');
        // Create a course.
        $course = self::getDataGenerator()->create_course();
        $coursecontext = context_course::instance($course->id);
        $enrolinstance = $DB->get_record('enrol', array('courseid' => $course->id, 'enrol' => 'ishinemanual'), '*', MUST_EXIST);
        // Set the capability for the user.
        $roleid = $this->assignUserCapability('enrol/ishinemanual:enrol', $coursecontext);
        $this->assignUserCapability('enrol/ishinemanual:unenrol', $coursecontext, $roleid);
        ...
        enrol_ishinemanual_external::unenrol_users(array(
