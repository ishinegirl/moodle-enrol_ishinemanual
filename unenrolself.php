...
/**
 * iShineManual enrolment plugin - support for user self unenrolment.
 *
...
$PAGE->set_url('/enrol/ishinemanual/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_ishinemanual', format_string($course->fullname));
